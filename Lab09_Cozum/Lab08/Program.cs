...
namespace Lab08
{
    ...
    {
        /*
         * Binary dosya yerine XML dosyasına serileştirme için kullanılabilecek örnek bir od aşağıdadır. Ancak XML serileştirmenin bazı limitleri vardır. Öncelikle 
